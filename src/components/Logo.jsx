      ...
      <div className={cn('relative', sizes[size].icon)}>
        <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <linearGradient id="logoGradTeal" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#14b8a6" />
              <stop offset="100%" stopColor="#0f766e" />
            </linearGradient>
          </defs>
          <circle cx="50" cy="50" r="48" fill="url(#logoGradTeal)" stroke="url(#logoGrad)" strokeWidth="1.5" />
          ...
          <path
            ...
            fill="url(#logoGrad)"
          />
          <circle cx="50" cy="43" r="5" fill="#134e4a" />
          <circle cx="50" cy="43" r="2.5" fill="#f97316" />
          <circle cx="20" cy="50" r="1.2" fill="#f97316" opacity="0.6" />
          <circle cx="80" cy="50" r="1.2" fill="#f97316" opacity="0.6" />
        </svg>
      </div>
      <div className="flex flex-col">
        <span className={cn('font-display font-bold tracking-tight text-ink-900 leading-none', sizes[size].text)}>
